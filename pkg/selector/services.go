...
func NewRegistry() ServiceRegistry { _ = "STUB: not implemented"; return *new(ServiceRegistry) }
...
func (sr *ServiceRegistry) RegisterAWSServices() { _ = "STUB: not implemented"; return }
